...
The board type is automatically detected based on the target chip. To support other boards, see the [esp_board_manager README](../../components/esp_board_manager/README.md).
